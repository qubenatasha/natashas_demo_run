...
HELLO_VERSION = "/v1/natashas_demo_run/version"
...
class Testnatashas_demo_runVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_natashas_demo_run_default_version(self, *args, **kwargs):
    ...
    def test_natashas_demo_run_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
