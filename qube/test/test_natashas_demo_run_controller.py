...
HELLO_WITH_ID = "/v1/natashas_demo_run/{}"
HELLO = "/v1/natashas_demo_run"
...
class Testnatashas_demo_runController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("before class")
    ...
    def setupDatabaseRecords(self):
        with patch('mongomock.write_concern.WriteConcern.__init__',
                   return_value=None):
            data = natashas_demo_run(name='test_record')
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_put_natashas_demo_run_item(self, *args, **kwargs):
        ...
        updated_record = natashas_demo_run.query.get(entity_id)
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_put_natashas_demo_run_item_non_found(self, *args, **kwargs):
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_get_natashas_demo_run(self, *args, **kwargs):
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(auth_response(), 200))
    def test_get_natashas_demo_run_item_not_found(self, *args, **kwargs):
    ...
    def test_delete_natashas_demo_run_item(self, *args, **kwargs):
        id_to_delete = str(self.data.mongo_id)
        rv = self.test_client.delete(HELLO_WITH_ID.format(id_to_delete),
                                     headers=self.headers)
        self.assertTrue(rv._status_code == 204)
        deleted_record = natashas_demo_run.query.get(id_to_delete)
        self.assertIsNone(deleted_record)

    @patch('mongomock.write_concern.WriteConcern.__init__', return_value=None)
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(system_user_auth_response(), 200))
    def test_delete_natashas_demo_run_item_notfound(self, *args, **kwargs):
    ...
    def test_get_natashas_demo_run_not_authorized(self, *args, **kwargs):
        rv = self.test_client.get(HELLO, headers=self.headers)
    ...
    def test_get_natashas_demo_run_master_token(self, *args, **kwargs):
        rv = self.test_client.get(HELLO, headers=self.headers)
    ...
    @patch('qube.src.api.decorators.validate_with_qubeship_auth',
           return_value=(no_auth_response(), 401))
    def test_get_natashas_demo_run_no_authorization(self, *args, **kwargs):
