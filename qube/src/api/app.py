...
from qube.src.api.natashas_demo_runcontroller import natashas_demo_runController
from qube.src.api.natashas_demo_runcontroller import natashas_demo_runItemController
from qube.src.api.versioncontroller import natashas_demo_runItemVersionController
...
api.add_resource(natashas_demo_runItemVersionController, '/v1/natashas_demo_run/version')
api.add_resource(natashas_demo_runController, '/v1/natashas_demo_run')
api.add_resource(natashas_demo_runItemController, '/v1/natashas_demo_run/<string:entity_id>')
