from qube.src.api.swagger_models.natashas_demo_run \
    import natashas_demo_runModel, natashas_demo_runModelPost
...
body_post_ex = {
    ...
    'description': 'Request body',
    'in': 'body',
    'schema': natashas_demo_runModelPost,
    'required': True,
}
