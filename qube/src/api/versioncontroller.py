...
from qube.src.api.swagger_models.natashas_demo_run import VersionModel
...
class natashas_demo_runItemVersionController(Resource):
    def __init__(self, *args, **kwargs):
        super(natashas_demo_runItemVersionController, self).__init__(*args, **kwargs)
        self.config = QubeConfig.get_config()

    @swagger.doc(
        {
            'tags': ['natashas_demo_run'],
            'description': 'natashas_demo_run Version operation',
